# -*- coding: utf-8 -*-
# @Time    : 2019/8/16 19:07
# @Author   : YeFD
# @FileName : build-model_w2v-svm_10.py
...
svm_model = SVC(C=10, kernel='rbf', probability=True, gamma='auto')
svm_model.fit(train_X, train_label)


def save_mod():
    joblib.dump(svm_model, 'svm_10.model')


save_mod()
end = time.process_time()
print('time=', end - start)
# svm_10.model time= 1615.875
