# -*- coding: utf-8 -*-
# @Time    : 2019/8/16 19:53
# @Author   : YeFD
# @FileName : build-model_w2v-svm_20.py
...
svm_model = SVC(C=20, kernel='rbf', probability=True, gamma='auto')
svm_model.fit(train_X, train_label)


def save_mod():
    joblib.dump(svm_model, 'svm_20.model')
